...
use Codelegacy\EntityModelRepositoryBlog\Model\ResourceModel\Blog\CollectionFactory as BlogCollectionFactory;
use Magento\Framework\Reflection\DataObjectProcessor;
use Magento\Framework\Exception\CouldNotSaveException;
use Codelegacy\EntityModelRepositoryBlog\Model\ResourceModel\Blog as ResourceBlog;
use Magento\Framework\Exception\NoSuchEntityException;
use Magento\Framework\Api\DataObjectHelper;
use Magento\Framework\Exception\CouldNotDeleteException;
use Codelegacy\EntityModelRepositoryBlog\Api\BlogRepositoryInterface;
use Codelegacy\EntityModelRepositoryBlog\Api\Data\BlogInterfaceFactory;
use Magento\Framework\Api\SearchCriteria\CollectionProcessorInterface;
use Magento\Framework\Api\ExtensionAttribute\JoinProcessorInterface;
use Codelegacy\EntityModelRepositoryBlog\Api\Data\BlogSearchResultsInterfaceFactory;
...
class BlogRepository implements BlogRepositoryInterface
{
    ...
    public function save(
        \Codelegacy\EntityModelRepositoryBlog\Api\Data\BlogInterface $blog
    ) {
        ...
        $blogData = $this->extensibleDataObjectConverter->toNestedArray(
            $blog,
            [],
            \Codelegacy\EntityModelRepositoryBlog\Api\Data\BlogInterface::class
        );
