...
namespace Codelegacy\CustomerEditButton\Block\Adminhtml\Edit;
...
class ExampleButton extends GenericButton implements ButtonProviderInterface
{
    ...
    {
        if (!$this->getCustomerId() && $this->authorization->isAllowed('Codelegacy_CustomerEditButton::example_action')) {
